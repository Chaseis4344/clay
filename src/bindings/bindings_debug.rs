...
pub type __v1du = [::core::ffi::c_ulonglong; 1usize];
pub type __v2su = [::core::ffi::c_uint; 2usize];
pub type __v4hu = [::core::ffi::c_ushort; 4usize];
pub type __v8qu = [::core::ffi::c_uchar; 8usize];
pub type __v8qs = [::core::ffi::c_schar; 8usize];
